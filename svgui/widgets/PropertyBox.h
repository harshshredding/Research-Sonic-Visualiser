...
public slots:
    ...
    void zoomSignalDetected();
    void zoomFrequencySignalDetected();
    void forwardZoomSignalDetected();
    void previousZoomSignalDetected();
    void receiveStartingFrequencyFromView(int start);
    void receiveEndingFrequencyFromView(int end);
...
protected:
    ...
    double timeToSecs(QString time);
    ...
    QComboBox *startBox;
    QComboBox *endBox;
    QComboBox *startFrequencyBox;
    QComboBox *endFrequencyBox;
