...
QT_MOC_LITERAL(3, 24, 9), // "cancelled"
QT_MOC_LITERAL(4, 34, 10), // "setMessage"
QT_MOC_LITERAL(5, 45, 4), // "text"
QT_MOC_LITERAL(6, 50, 11), // "setProgress"
QT_MOC_LITERAL(7, 62, 10), // "percentage"
QT_MOC_LITERAL(8, 73, 16), // "showTimerElapsed"
QT_MOC_LITERAL(9, 90, 8) // "canceled"

    },
    "ProgressDialog\0showing\0\0cancelled\0"
    "setMessage\0text\0setProgress\0percentage\0"
    "showTimerElapsed\0canceled"
};
...
void ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->showTimerElapsed(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressDialog::showing)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ProgressDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressDialog::cancelled)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ProgressDialog::staticMetaObject = {
    { &ProgressReporter::staticMetaObject, qt_meta_stringdata_ProgressDialog.data,
