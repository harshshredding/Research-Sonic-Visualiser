/****************************************************************************
** Meta object code from reading C++ file 'ProgressReporter.h'
**
...
#include "../svcore/base/ProgressReporter.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ProgressReporter.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 17, 9), // "cancelled"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10), // "setMessage"
QT_MOC_LITERAL(4, 39, 4), // "text"
QT_MOC_LITERAL(5, 44, 11), // "setProgress"
QT_MOC_LITERAL(6, 56, 10) // "percentage"

    },
    "ProgressReporter\0cancelled\0\0setMessage\0"
    "text\0setProgress\0percentage"
};
...
void ProgressReporter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ProgressReporter *_t = static_cast<ProgressReporter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cancelled(); break;
        case 1: _t->setMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (ProgressReporter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressReporter::cancelled)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ProgressReporter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ProgressReporter.data,
      qt_meta_data_ProgressReporter,  qt_static_metacall, nullptr, nullptr}
};
...
void *ProgressReporter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProgressReporter.stringdata0))
        return static_cast<void*>(const_cast< ProgressReporter*>(this));
