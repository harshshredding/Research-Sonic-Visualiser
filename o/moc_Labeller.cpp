...
const QMetaObject Labeller::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Labeller.data,
      qt_meta_data_Labeller,  qt_static_metacall, nullptr, nullptr}
};
...
void *Labeller::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Labeller.stringdata0))
        return static_cast<void*>(const_cast< Labeller*>(this));
