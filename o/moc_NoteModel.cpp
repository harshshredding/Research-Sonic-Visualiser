...
const QMetaObject NoteModel::staticMetaObject = {
    { &IntervalModel<Note>::staticMetaObject, qt_meta_stringdata_NoteModel.data,
...
void *NoteModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "NoteExportable"))
        return static_cast< NoteExportable*>(const_cast< NoteModel*>(this));
    return IntervalModel<Note>::qt_metacast(_clname);
}

int NoteModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = IntervalModel<Note>::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
