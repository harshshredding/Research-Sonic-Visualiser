...
QT_MOC_LITERAL(1, 12, 13), // "recentChanged"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "RecentFiles\0recentChanged\0"
};
...
void RecentFiles::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RecentFiles::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RecentFiles::recentChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RecentFiles::recentChanged()
{
