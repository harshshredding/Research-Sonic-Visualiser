...
#include "../svcore/data/model/ImageModel.h"
...
const QMetaObject ImageModel::staticMetaObject = {
    { &SparseModel<ImagePoint>::staticMetaObject, qt_meta_stringdata_ImageModel.data,
...
void *ImageModel::qt_metacast(const char *_clname)
{
    ...
    return SparseModel<ImagePoint>::qt_metacast(_clname);
}

int ImageModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SparseModel<ImagePoint>::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
